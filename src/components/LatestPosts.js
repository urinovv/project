...
import postThird from '../assets/images/l4.png';
import postFourth from '../assets/images/b4.png';
        ...
        <section className="latest-posts d-flex justify-content-center align-items-center">
            <div className="latest-posts-container d-flex flex-column justify-content-center align-items-center gap-4">
                ...
                <div className="latest-container d-flex flex-row align-items-start justify-content-center gap-5">
                    ...
                    <Link to={`blogs/5 Must-Have Gadgets for the Modern Home`} className={"text-decoration-none text-dark w-25"}>
                        <div
                            className="latest-posts-content d-flex flex-column align-items-start justify-content-center gap-2 w-100">
                            <div
                            ...
                            <UncontrolledCollapse toggler="#toggler">
                                <Card>
                                    <CardBody className={"read-more-texts"}>
                                        ...
                                        discover how these innovations can enhance your daily life and bring convenience
                                        to your fingertips.
                                    </CardBody>
                                </Card>
                    ...
                    <Link to={`blogs/Eco-Friendly Innovations Making a Difference`} className={"text-decoration-none text-dark w-25"}>
                        <div
                            className="latest-posts-content d-flex flex-column align-items-start justify-content-center gap-2 w-100">
                            <div
                                className="posts-content-image d-flex flex-column align-items-start justify-content-center gap-0 m-0">
                    ...
                    <Link to={`blogs/Top Apps and Tools for Remote Work`} className={"text-decoration-none text-dark w-25"}>
                        <div
                            className="latest-posts-content d-flex flex-column align-items-start justify-content-center gap-2 w-100">
                            <div
                                className="posts-content-image d-flex flex-column align-items-start justify-content-center gap-0 m-0">
                            ...
                            <UncontrolledCollapse toggler="#toggler2">
                                <Card>
                                    <CardBody className={"read-more-texts"}>
                                        Stay ahead of the curve with our insightful look into the rapidly evolving
                                        landscape
                                        of wearable technology.
                                        Explore the latest trends, from health monitoring devices to fashion-forward
                                        wearables,
                    ...
                    <Link to={`blogs/Eco-Friendly Innovations Making a Difference(1)`} className={"text-decoration-none text-dark w-25"}>
                        <div
                            className="latest-posts-content d-flex flex-column align-items-start justify-content-center gap-2 w-100">
                            <div
                                className="posts-content-image d-flex flex-column align-items-start justify-content-center gap-0 m-0">
                            ...
                            <UncontrolledCollapse toggler="#toggler3">
                                <Card>
                                    <CardBody className={"read-more-texts"}>
                                        In today's remote work environment, productivity is key. Discover the top apps
                                        and
