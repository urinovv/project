...
import post7 from '../assets/images/b7.png';
        ...
        <section className="blog-post">
            <div className="blog-post-container d-flex flex-column justify-content-center align-items-center">
                <div
                    ...
                    <img src={post7} alt="post" width={"75%"} height={"600px"}/>
                ...
                <div
                    ...
                    <div
                        ...
                        <NavLink to={`/blogs/5 Must-Have Gadgets for the Modern Home(2)`} className={"text-decoration-none text-dark"}>
