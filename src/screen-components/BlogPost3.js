...
import post3 from '../assets/images/ins2.png';
        ...
        <section className="blog-post">
            <div className="blog-post-container d-flex flex-column justify-content-center align-items-center">
                <div
                    ...
                    <img src={post3} alt="post" width={"75%"} height={"600px"}/>
                ...
                <div
                    ...
                    <div
                        ...
                        <NavLink to={`/blogs/Eco-Friendly Innovations Making a Difference(1)`} className={"text-decoration-none text-dark"}>
