...
import post1 from '../assets/images/Blog img & date.png';
        ...
        <section className="blog-post">
            <div className="blog-post-container d-flex flex-column justify-content-center align-items-center">
                <div
                    ...
                    <img src={post1} alt="post" width={"75%"} height={"600px"}/>
                ...
                <div
                    ...
                    <div
                        ...
                        <NavLink to={`/blogs/Eco-Friendly Innovations Making a Difference`} className={"text-decoration-none text-dark"}>
                    ...
                    <div
                        ...
                        <form className={"write-a-comment d-flex flex-column gap-2 w-75 m-xl-4"}>
                            ...
                            <input className={"leave-comment w-100"} type="text" placeholder={"Write your comment here *"} required/>
                            <div className={"d-flex flex-row w-100 gap-2"}>
                                <input className={"leave-comment w-50"} type="text" placeholder={"Write your name here *"} required/>
                                <input className={"leave-comment w-50"} type="email" placeholder={"Write your email here *"} required/>
                            </div>
