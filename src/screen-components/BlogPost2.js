...
import post2 from '../assets/images/l2.png';
        ...
        <section className="blog-post">
            <div className="blog-post-container d-flex flex-column justify-content-center align-items-center">
                <div
                    ...
                    <img src={post2} alt="post" width={"75%"} height={"600px"}/>
                ...
                <div
                    ...
                    <div
                        ...
                        <NavLink to={`/blogs/5 Must-Have Gadgets for the Modern Home`} className={"text-decoration-none text-dark"}>
