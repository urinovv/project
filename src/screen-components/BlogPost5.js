...
import post5 from '../assets/images/b5.png';
        ...
        <section className="blog-post">
            <div className="blog-post-container d-flex flex-column justify-content-center align-items-center">
                <div
                    ...
                    <img src={post5} alt="post" width={"75%"} height={"600px"}/>
                ...
                <div
                    ...
                    <div
                        ...
                        <NavLink to={`/blogs/Top Apps and Tools for Remote Work(1)`} className={"text-decoration-none text-dark"}>
