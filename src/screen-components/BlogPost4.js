...
import post4 from '../assets/images/b4.png';
        ...
        <section className="blog-post">
            <div className="blog-post-container d-flex flex-column justify-content-center align-items-center">
                <div
                    ...
                    <img src={post4} alt="post" width={"75%"} height={"600px"}/>
                ...
                <div
                    ...
                    <div
                        ...
                        <NavLink to={`/blogs/Top Apps and Tools for Remote Work`} className={"text-decoration-none text-dark"}>
                            <p className={"fs-5 text-uppercase"}>◀ Prev</p>
                        </NavLink>
                        <NavLink to={`/blogs/5 Must-Have Gadgets for the Modern Home(1)`} className={"text-decoration-none text-dark"}>
